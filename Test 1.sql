...
-- РЕШЕНИЕ ЗАДАЧИ
SELECT gt.goods_type_name, SUM(o.total)
FROM goods_type AS gt
JOIN goods AS g ON (g.goods_type_id=gt.goods_type_id)
JOIN orders AS o ON (o.goods_id=g.goods_id)
GROUP BY gt.goods_type_name
